...
export const createLoserOverlayComponent = (config: Config) =>
  observer(
    class LoserOverlay extends Component<LoserOverlayProps, LoserOverlayState> {
...
export default createLoserOverlayComponent(Config.instance);
