...
export const createRoundViewComponent = (config: Config) =>
  observer(
    class RoundView extends Component<RoundViewProps, RoundViewState> {
      ...
      private onMatchCompleteWithDelay = (): unknown =>
        setTimeout(this.props.onMatchComplete, 500 / config.speed);
      ...
      public render = (): JSX.Element => (
        <Fragment
          key={`round-${
            this.props.round.id
          }-match-${this.getCurrentMatchIndex()}`}
        >
...
export default createRoundViewComponent(Config.instance);
